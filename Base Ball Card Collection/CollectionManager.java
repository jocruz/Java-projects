...
public class CollectionManager {
	...
	public static void add() {
		...
		catch (IllegalArgumentException | InputMismatchException | FullCollectionException e) {
	...
	public static void updatePrice() {
		...
		if(coll.equals("A")) { //update price
			try {
				...
				if(prc < 0)
					System.out.println("\nFailed to update price.  Invalid price.\n");
				else
					System.out.println("\nFailed to update price.  No card in this position.\n");
			}
	...
	public static void getCard() {
		...
		if(coll.equals("A")) {
			...
			System.out.printf("%-3s%-25s%-25s%-6s%-8s%-12s","#","Name","Manufacturer","Year","Price","Size");
			System.out.println();
			System.out.printf("%-3s%-25s%-25s%-6s%-8s%-12s","--","----","------------","----","-----","----");
			System.out.println();
			System.out.printf("%-3d%-25s%-25s%-6d%-8.2f%-12s",pos, c.getPlayerName(),c.getCardManufacturer(),c.getYear(),c.getPrice(),c.getSizeX() + "x" + c.getSizeY());
		}
	...
	public static void trade() {
		...
		BaseballCard card1;
		try {
			card1 = A.getCard(pos1);
		}
		catch(IllegalArgumentException e) {
			System.out.println("Failed to trade.  No card in this position.\n");
			return;
		}
